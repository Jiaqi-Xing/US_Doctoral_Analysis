...
# Introduction 
Our data is obtained from [@ipums2022]. The dataset was cleaned and processed using R [@citeR], with help of packages readr[@readr] and tidyverse [@tidyverse]. The cleaning process involved removing any unnecessary variables, and calculating the LaPlace estimations.
